...
#'
#' @param indicator A character, the IFS database indicator as in \code{\link{ifs_indicators}}.
#' @param country A character, the ISO code of the country as in \code{\link{ifs_countries}}.
